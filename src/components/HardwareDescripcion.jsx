...
export default function HardwareDescripcion() {
  return (
    <Reveal as="section" className="w-full flex items-center justify-center px-6 py-12 md:h-[417px] bg-gradient-to-b from-[#030C40] to-[#172555] border-t border-b border-white/60">
