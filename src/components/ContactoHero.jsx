...
export default function ContactoHero() {
  ...
  return (
    <section className="relative w-full h-[413px] md:h-[454px] flex items-center justify-center overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 flex flex-col items-center text-center gap-[23px] px-6">
        <h1 className="r-reveal text-white font-bold text-[40px] md:text-[64px] leading-tight md:leading-[75px]">
          Contacto
        </h1>
        <p className="r-reveal text-white/90 font-semibold text-[16px] md:text-[24px]">
          Estamos para ayudarte a dar el primer paso
        </p>
      </div>
    </section>
  )
