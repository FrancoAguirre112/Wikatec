...
export default function HardwareHero() {
  return (
    <section className="relative w-full h-[320px] md:h-[441px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/hardware-hero-app.webp')" }} />
      ...
      <Reveal as="div" className="relative z-10 text-center px-6">
