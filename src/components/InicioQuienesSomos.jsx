...
export default function QuienesSomos() {
  return (
    <Reveal as="section" id="quienes-somos" className="py-12 md:py-20 px-6 bg-gradient-to-b from-[#030C40] to-[#172555] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] scroll-mt-[67px]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-[75px]">
        ...
        <div className="w-full md:w-[55%] order-2">
          <SmoothImage src="/images/quienes-somos.jpg" alt="Equipo Kiwatec" loading="eager" fetchPriority="high" className="w-full object-cover h-[250px] md:h-[416px] rounded-[23px] opacity-[0.79] drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]" />
        </div>
